...
export default {
  ...
  methods: {
    getHistoryToday() {
      this.items = []
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/today`)
        .then(response => {
    ...
    getHistoryWeek() {
      this.items = []
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/week`)
        .then(response => {
          this.history = response.data.data
          this.history.map((value) => {
            const setItem = {
    ...
    getHistoryMonth() {
      this.items = []
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/month`)
        .then(response => {
          this.history = response.data.data
          this.history.map((value) => {
            const setItem = {
    ...
    getDataChart() {
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/chart?date=${this.currDate}`)
        .then(response => {
    ...
    getPrevIncome() {
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/income?date=${this.prevDate}`)
        .then(response => {
    ...
    getYearIncome() {
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/incomeyear?date=${this.currDate}`)
        .then(response => {
    ...
    getPrevYearIncome() {
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/incomeyear?date=${this.prevYear}`)
        .then(response => {
    ...
    getCountHistoryWeek() {
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/count?date=${this.currDate}`)
        .then(response => {
    ...
    getCountHistoryLastWeek() {
      axios
        .get(`${process.env.VUE_APP_BASE_URL}/history/count?date=${this.prevWeek}`)
        .then(response => {
